...
urlpatterns = [
    ...
    path('', views.random_data_html, name = 'random_data_html'),
    path('new/', views.random_data_html, name = 'random_data_html'),
    path('stored/', views.random_data_html, name = 'random_data_html'),
